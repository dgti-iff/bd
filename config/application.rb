...
module DigitalLibrary
  class Application < Rails::Application
    ...
    config.sam_configuration = YAML.load_file(Rails.root.join('config', 'sam.yml'))[Rails.env].symbolize_keys
...
#      symbolize_keys
    ...
    config.elasticsearch_config = YAML.load_file(Rails.root.join('config', 'elasticsearch.yml'))[Rails.env].symbolize_keys
...
#      symbolize_keys
    ...
    config.mailer_configuration = YAML.load_file(Rails.root.join('config', 'mail.yml'))[Rails.env].symbolize_keys
