...
ActiveRecord::Schema.define(version: 20121004182913) do
  ...
  add_index "mudancas_de_estado", ["conteudo_id"], name: "index_mudancas_de_estado_on_conteudo_id", using: :btree
  add_index "mudancas_de_estado", ["usuario_id"], name: "index_mudancas_de_estado_on_usuario_id", using: :btree
